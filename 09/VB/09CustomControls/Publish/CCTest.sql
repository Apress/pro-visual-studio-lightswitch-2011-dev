...
GO
PRINT N'Creating [dbo].[CustomerPayments]...';
...
GO
PRINT N'Creating PK_CustomerPayments...';


GO
ALTER TABLE [dbo].[CustomerPayments]
    ADD CONSTRAINT [PK_CustomerPayments] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[ProductFeedbacks]...';
...
GO
PRINT N'Creating PK_ProductFeedbacks...';


GO
ALTER TABLE [dbo].[ProductFeedbacks]
    ADD CONSTRAINT [PK_ProductFeedbacks] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[ValidationChecks]...';


GO
CREATE TABLE [dbo].[ValidationChecks] (
    [Id]          INT             IDENTITY (1, 1) NOT NULL,
    [StringIsReq] NVARCHAR (255)  NOT NULL,
    [NumIsReq]    DECIMAL (18, 2) NOT NULL,
    [DateIsReq]   DATETIME        NOT NULL
);


GO
PRINT N'Creating PK_ValidationChecks...';


GO
ALTER TABLE [dbo].[ValidationChecks]
    ADD CONSTRAINT [PK_ValidationChecks] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating DF_CustomerPayments_CustomerID...';


GO
ALTER TABLE [dbo].[CustomerPayments]
    ADD CONSTRAINT [DF_CustomerPayments_CustomerID] DEFAULT ((0)) FOR [CustomerID];


GO
PRINT N'Creating DF_CustomerPayments_CreditCardNumber...';


GO
ALTER TABLE [dbo].[CustomerPayments]
    ADD CONSTRAINT [DF_CustomerPayments_CreditCardNumber] DEFAULT ('') FOR [CreditCardNumber];


GO
PRINT N'Creating DF_ProductFeedbacks_ProductDescription...';


GO
ALTER TABLE [dbo].[ProductFeedbacks]
    ADD CONSTRAINT [DF_ProductFeedbacks_ProductDescription] DEFAULT ('') FOR [ProductDescription];


GO
PRINT N'Creating DF_ProductFeedbacks_Satisfaction...';


GO
ALTER TABLE [dbo].[ProductFeedbacks]
    ADD CONSTRAINT [DF_ProductFeedbacks_Satisfaction] DEFAULT ((0)) FOR [Satisfaction];


GO
PRINT N'Creating DF_ValidationChecks_StringIsReq...';


GO
ALTER TABLE [dbo].[ValidationChecks]
    ADD CONSTRAINT [DF_ValidationChecks_StringIsReq] DEFAULT ('') FOR [StringIsReq];


GO
PRINT N'Creating DF_ValidationChecks_NumIsReq...';


GO
ALTER TABLE [dbo].[ValidationChecks]
    ADD CONSTRAINT [DF_ValidationChecks_NumIsReq] DEFAULT ((0)) FOR [NumIsReq];


GO
PRINT N'Creating DF_ValidationChecks_DateIsReq...';


GO
ALTER TABLE [dbo].[ValidationChecks]
    ADD CONSTRAINT [DF_ValidationChecks_DateIsReq] DEFAULT ((0)) FOR [DateIsReq];
